...
const { getPool } = require('../config/database'); // CAMBIO CLAVE: Importamos la función getPool
...
const chat = async (req, res) => {
    ...
    try {
        // CAMBIO CLAVE: Obtenemos el pool usando la función.
        ...
        // A partir de aquí, el resto de tu lógica es perfecta y ahora funcionará.
        ...
        const chatSession = geminiModel.startChat({ /* de momento no se necesita config aquí */ });
        ...
        // En producción, es mejor no enviar el stack al cliente.
